        ...
        messages=[
            {
                ...
                "content": 
                    ...
                    Analyze the given transcript and extract meaningful verbatims that directly answer this research question: "{research_question}"
                    ...
                    - Format: "{file_name}","verbatim","theme","sentiment"
                    ...
                    ### Reference Examples
                    "{file_name}","It takes me four clicks just to export a simple PDF report.","Export friction","Negative"
                    "{file_name}","I check the dashboard every single morning before I even open my email.","Daily workflow routine","Neutral"
                    "{file_name}","The auto-save feature saved my life when my browser crashed yesterday.","Data protection safety","Positive"
                    """,
            },
            {
                "role": "user",
...
print(f"Analysis completed and appended to {csv_filename}.")
